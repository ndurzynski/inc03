...
class _ControlDeckScreenState extends State<ControlDeckScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final screenBg = isOverload
      ? (widget.isDark ? const Color.fromARGB(255, 75, 36, 30) : const Color(0xFFFBE6DF))
            ...
            Wrap(
              ...
              children: [
                TactileButton(
                  ...
                  onPressed: () => _triggerAction("Cool Music"),
                ),
                TactileButton(
                  icon: Icons.vpn_lock,
                  label: "Enable VPN",
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("OPSEC"),
                ),
                TactileButton(
                  icon: Icons.radar,
                  label: "Free WiFi Scanner",
                  accentColor: Colors.blue,
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("FREE WIFI WHEREVER YOU GO"),
                ),
                TactileButton(
                  icon: Icons.local_grocery_store,
                  label: "Order DoorDash",
                  accentColor: Colors.redAccent,
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("DOORDASH FEES"),
                ),
              ],
            ),
